...
namespace State.Controllers
{
	...
	public class TasksController : Controller
	{
		...
		public async Task<IActionResult> StartTask(int id)
		{
			...
			// Alteração é realizada se a tarefa estiver criada 
			...
			{
				return BadRequest("Tarefa não pode ser criada, tente novamente mais tarde");
			}
		...
		public async Task<IActionResult> CompleteTask(int id)
		{
            ...
            // Alteração é realizada se a tarefa estiver em progresso
			...
			{
				return BadRequest("Tarefa não pode ser completada");
			}
		...
		public async Task<IActionResult> CancelTask(int id)
		{
			...
			{
				return BadRequest("Tarefa não pode ser cancelada, tente novamente mais tarde");
			}
